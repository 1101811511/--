...
public class PreferenceUtil {
    ...
    public static void putString(String key, String value) {
        if (!TextUtils.isEmpty(value) & !TextUtils.isEmpty(key)) {
            String encrypt = EncryptUtil.base64encode(value);
    ...
    public static String getString(String key, String defaultValue) {
        ...
        if (!TextUtils.isEmpty(origin)) {
            return EncryptUtil.base64decode(origin);
        }
        return defaultValue;
    }
    ...
    private static SharedPreferences getSharedPreference() {
        return gContext.getSharedPreferences("user", Context.MODE_PRIVATE);
    }

    private static SharedPreferences.Editor getEditor() {
        SharedPreferences sp = getc.getSharedPreferences("user", Context.MODE_PRIVATE);
        return sp.edit();
    }
}
